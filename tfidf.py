...
class TFIDF:
    ...
    def find_similarity(self, corpus):
        ...
        # self.most_similar(documents_df, 0, pairwise_differences, 'Euclidean Distance')
    ...
    def most_similar(self, documents_df, doc_id, similarity_matrix, matrix):
        ...
        return similarity_matrix[doc_id][similar_ix[1]] # second index -- first index is always the same document
